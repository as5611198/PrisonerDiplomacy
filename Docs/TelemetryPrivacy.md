...
The production AI stages are enabled as of 2026-08-21. Provider failures never block report ingestion or gameplay; queued repair work remains persisted for the bounded retry schedule.
...
正式環境的 AI 階段已於 2026-08-21 啟用。供應商故障不會阻塞錯誤接收或遊戲流程；待修工作會依有上限的重試排程持續保留。
